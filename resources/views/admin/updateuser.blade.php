            ...
            <div class="card-header">
                <form method="POST" action="{{ route('update.user', ['id' => $users->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ $users->nama_lengkap }}" class="form-control @error('nama_lengkap') is-invalid @enderror" name="nama_lengkap"
                    ...
                    <div class="mb-3">
                            <label for="alamat_lengkap_saat_ini" class="form-label">Alamat_lengkap_saat_ini Lengkap</label>
                            <input type="alamat_lengkap_saat_ini" value="{{ $users->alamat_lengkap_saat_ini }}" class="form-control @error('alamat_lengkap_saat_ini') is-invalid @enderror" name="alamat_lengkap_saat_ini"
                    ...
                    <div class="mb-3">
                            ...
                            <input type="no_hp" value="{{ $users->no_hp }}" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp"
